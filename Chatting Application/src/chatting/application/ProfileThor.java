...
//        p1.add(i111);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/thor.png"));
        Image i2 = i1.getImage().getScaledInstance(80, 80, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel dp = new JLabel(i3);
        dp.setBounds(185, 50, 80, 80);
        p1.add(dp);
       ...
       JLabel phn = new JLabel("+91 70041 33010");
