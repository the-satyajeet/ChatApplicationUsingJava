...
public class Client0 implements ActionListener
{
    JTextField text;
    static JPanel a1;
    ...
    Client0(String s)
    {
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/iron-man.png"));
       ...
       morevert.setBounds(410, 20, 25, 25);
       p1.add(morevert);
       ...
       JLabel name = new JLabel("Client 0");
...
//       f.add(text);
    ...
    public void actionPerformed(ActionEvent ae)
    {
       try
       {
       String out = t1.getText()+str;
       //String out = t1.getText()+" #client 1";
       ...
       public static JPanel formatLabel(String out)
       {
           ...
           JLabel output = new JLabel("<html><p font color=white style=\"width: 150px\">" + out + "</p> </html>");
           output.setFont(new Font("Tahoma", Font.PLAIN, 16));
           output.setBackground(new Color(191,4,54));
